...
![Connectivity matrix with nodes reordered so detected subnetworks form
diagonal blocks](reference/figures/README-heatmap-1.png)

plot of chunk heatmap

Nodes are reordered so that each extracted subnetwork occupies a
contiguous block on the diagonal; significant blocks are outlined. The
colour scale is labelled with the statistic being displayed — here
`-log10(p)`, because that is what
...
pw <- power_curve(n = c(40, 60, 80, 120, 160),
                  n_nodes = 80, cluster_size = 20, f2 = 0.06,
...
#>   40 0.955 (0.015) 0.955 (0.015) 0.816  0.96
#>   60 1.000 (0.000) 1.000 (0.000) 0.938  1.00
#>   80 1.000 (0.000) 1.000 (0.000) 0.976  1.00
#>  120 1.000 (0.000) 1.000 (0.000) 0.993  1.00
#>  160 1.000 (0.000) 1.000 (0.000) 0.997  1.00
#> 
...
![Power curves against sample size for any detection and for correct
recovery](reference/figures/README-power-1.png)
