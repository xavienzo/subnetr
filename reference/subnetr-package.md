...
max-statistic permutation test. The peeling and permutation machinery is
implemented in C++ over a sparse representation of the screened graph,
roughly an order of magnitude faster end to end than an equivalent
vectorized implementation of the reference algorithm, which makes the
repeated model fitting required for power analysis practical. Methods
follow Wu et al. (2022)
